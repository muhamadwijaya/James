...
class PalletPage(OperationPage):
    ...
    def __init__(self,store):
        ...
        for spec in [('stage_start_scan',139,899,146,43,'START SCAN CARTON','play','green'),('stage_print_label',297,899,153,43,'PRINT LABEL','printer','blue'),('stage_reset',462,899,143,43,'RESET PALLET','sync','gold'),('stage_conveyor',617,899,161,43,'START CONVEYOR','conveyor','blue'),('stage_upload',923,899,158,43,'UPLOAD INSTAN','upload','blue')]:self.button(*spec)
